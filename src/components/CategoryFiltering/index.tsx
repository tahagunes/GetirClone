...
const CategoryBox = ({item,active}:{item:Category,active:Category}) => {
    return(
        <View style={[{paddingHorizontal:9,flexDirection:'row',alignItems:'center',justifyContent:'center'},item.name==active.name && {borderBlockColor:'#FFD00C',borderBottomWidth:2.5}]}>
